...
% %     filename = sprintf('Simulation_size5/fluence_1e9_top_sTO2_%.1f_sBO2_0.6.mat',sTO2); 
   load(filename)
    ...
    SO2_cc_diff(i ,8 ) = convexConeSO2(fluence_spectrum8(sele_wavlen).*blood_mu_a(sele_wavlen),spectrum_Hb ,spectrum_HbO2, My_ColorBase_s);
...
% set(gcf, 'Color', 'w');
% hold off;
save(sprintf('/home/zz111/Spectral_unmixing/Convex-Cone-Approach-main/sO2_predictionDT_deepmore_nonuni_theirHcc_direct_num%d.mat',save_num),"SO2_cc_diff");
